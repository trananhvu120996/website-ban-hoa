...
<div class="price-box">
<span class="price">{{ $h->Gia }}<sup>đ</sup></span>
</div>
</div>
</div>
		...
		<li class="gategory-product-list col-lg-3 col-md-4 col-sm-6 col-xs-12">
			<div class="single-product-item">
				<div class="product-image">
					<a href="single-product-{{ $h->MaHoa }}.html"><img src="{{url('/')}}/img/images/hoa/{{ $h->Hinh }}" alt="product-image" style="max-width :458px; max-height :120px" /></a>
					<a href="single-product-{{ $h->MaHoa }}.html" class="new-mark-box">new</a>
					<div class="overlay-content">
						<ul>
							<li><a href="#" title="Quick view"><i class="fa fa-search"></i></a></li>
							<li><a href="{{url('/')}}/mua-hang-product-{{ $h->MaHoa }}" title="Quick view"><i class="fa fa-shopping-cart"></i></a></li>
							<li><a href="single-product-{{ $h->MaHoa }}.html" title="Quick view"><i class="fa fa-retweet"></i></a></li>
